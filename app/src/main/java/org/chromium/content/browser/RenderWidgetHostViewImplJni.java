...
final class RenderWidgetHostViewImplJni implements RenderWidgetHostViewImpl.Natives {
  ...
  public static final JniStaticTestMocker<RenderWidgetHostViewImpl.Natives> TEST_HOOKS = new JniStaticTestMocker<org.chromium.content.browser.RenderWidgetHostViewImpl.Natives>() {
    @Override
  ...
  @Override
  public void writeContentBitmapAsync(long nativeRenderWidgetHostViewAndroid,
      RenderWidgetHostViewImpl caller, int width, int height, Callback<Bitmap> callback) {
    N.MslKmr9t(nativeRenderWidgetHostViewAndroid, caller, width, height, callback);
  }
