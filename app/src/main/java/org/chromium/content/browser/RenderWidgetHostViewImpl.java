...
public class RenderWidgetHostViewImpl implements RenderWidgetHostView {
    ...
    @Override
    public void writeContentBitmapAsync(
            int width, int height, Callback<Bitmap> callback) {
        RenderWidgetHostViewImplJni.get().writeContentBitmapAsync(
                getNativePtr(), RenderWidgetHostViewImpl.this, width, height, callback);
    }
    ...
    interface Natives {
        ...
        void writeContentBitmapAsync(long nativeRenderWidgetHostViewAndroid,
                                     RenderWidgetHostViewImpl caller, int width, int height,
